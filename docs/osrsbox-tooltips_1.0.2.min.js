 ...
 * http://jquery.org/license
 */
var G;if(x.uiBackCompat!==false){G=x.effects.define("transfer",function(O,N){x(this).transfer(O,N)})}var d=G}));$(document).ready(function(){$(document).osrstooltip();$(".osrstooltip").osrstooltip({track:true,open:function(b,c){var a=this.id;var d="https://www.osrsbox.com/osrsbox-db/items-json/";var e=d+a+".json";$.ajax({type:"get",url:e,dataType:"json",success:successFunction,error:errorFunction})}});$(".osrstooltip").mouseout(function(){$(this).attr("title","Please wait...");$(this).osrstooltip();$(".ui-osrstooltip").hide()})});function successFunction(q){var j="";var d="<span class='item_left'>";var o="<span class='item_right'>";var i="</span>";var c="<br/>";var h="<div class='osrstooltip-clear'></div>";var g=q.id.toString();var a="https://www.osrsbox.com/osrsbox-db/items-icons/"+q.id+".png";var r=q.name;var m="<span class='osrstooltip-image'><img src="+a+" alt="+r+"></span><span class='osrstooltip-name'>"+r+"</span><br/>";var e=document.getElementById(g);var k=e.dataset.type;var l=Object.freeze(["full","half","short","bonuses"]);if(l.indexOf(k)===-1){console.log("ERROR: Incorrect tooltip type");k="full"}if(k==="short"){j="<div>"+m+"</div>";$("#"+q.id).osrstooltip("option","content",j);return}var f="<span class='osrstooltip-textleft'>Members Item : </span><span class='osrstooltip-textright'>"+boolToString(q.members)+"</span><br/><span class='osrstooltip-textleft'>Quest Item : </span><span class='osrstooltip-textright'>"+boolToString(q.quest_item)+"</span><br/><span class='osrstooltip-textleft'>Stackable : </span><span class='osrstooltip-textright'>"+boolToString(q.stackable)+"</span><br/><span class='osrstooltip-textleft'>Equipable : </span><span class='osrstooltip-textright'>"+boolToString(q.equipable)+"</span><br/><span class='osrstooltip-textleft'>Tradeable : </span><span class='osrstooltip-textright'>"+boolToString(q.tradeable)+"</span><br/><span class='osrstooltip-textleft'>High Alchemy : </span><span class='osrstooltip-textright'>"+q.highalch+"</span><br/><span class='osrstooltip-textleft'>Low Alchemy : </span><span class='osrstooltip-textright'>"+q.lowalch+"</span><br/>";if(q.equipable==false||k==="half"){j="<div>"+m+h+f+h+"</div>";$("#"+q.id).osrstooltip("option","content",j);return}var p="<table class='osrstooltip-table'><tr><th colspan='5'>Attack Bonus</th></tr><tr><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/stab.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/slash.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/crush.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/magic.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/ranged.png' alt=''></td></tr><tr><td>"+q.bonuses["attack_stab"]+"</td><td>"+q.bonuses["attack_slash"]+"</td><td>"+q.bonuses["attack_crush"]+"</td><td>"+q.bonuses["attack_magic"]+"</td><td>"+q.bonuses["attack_ranged"]+"</td></tr>";var n="<tr><th colspan='5'>Defence Bonus</th></tr><tr><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/stab.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/slash.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/crush.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/magic.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/ranged.png' alt=''></td></tr><tr><td>"+q.bonuses["defence_stab"]+"</td><td>"+q.bonuses["defence_slash"]+"</td><td>"+q.bonuses["defence_crush"]+"</td><td>"+q.bonuses["defence_magic"]+"</td><td>"+q.bonuses["defence_ranged"]+"</td></tr>";var b="<tr><th colspan='4'>Other Bonuses</th></tr><tr><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/melee_strength.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/ranged_strength.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/magic_damage.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/prayer.png' alt=''></td></tr><tr><td>"+q.bonuses["melee_strength"]+"</td><td>"+q.bonuses["ranged_strength"]+"</td><td>"+q.bonuses["magic_damage"]+"</td><td>"+q.bonuses["prayer"]+"</td></tr></table>";if(k==="bonuses"){j="<div>"+m+h+p+n+b+"</div>";$("#"+q.id).osrstooltip("option","content",j);return}j="<div>"+m+h+f+h+p+n+b+"</div>";$("#"+q.id).osrstooltip("option","content",j)}function errorFunction(a){$("#"+a.id).osrstooltip("option","content","Error getting content.")}function boolToString(a){if(a==true){return"True"}else{return"False"}};
