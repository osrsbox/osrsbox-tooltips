 ...
 * http://jquery.org/license
 */
var G;if(x.uiBackCompat!==false){G=x.effects.define("transfer",function(O,N){x(this).transfer(O,N)})}var d=G}));$(document).ready(function(){$(document).osrstooltip();$(".osrstooltip").osrstooltip({track:true,open:function(c,d){var a=this.id;var b=a.charAt(0);var e="https://www.osrsbox.com/osrsbox-db/items-json/";var f=e+a+".json";$.ajax({type:"get",url:f,dataType:"json",success:successFunction,error:errorFunction})}});$(".osrstooltip").mouseout(function(){$(this).attr("title","Please wait...");$(this).osrstooltip();$(".ui-osrstooltip").hide()})});function successFunction(h){var p="";var f="<span class='item_left'>";var n="<span class='item_right'>";var b="</span>";var o="<br/>";var j="<div class='osrstooltip-clear'></div>";var e=h.id.toString();var d=e.charAt(0);var m="https://www.osrsbox.com/osrsbox-db/items-icons/"+h.id+".png";var a=h.name;var i="<span class='osrstooltip-image'><img src="+m+" alt="+a+"></span><span class='osrstooltip-name'>"+a+"</span><br/>";var l="<span class='osrstooltip-textleft'>Members Item : </span><span class='osrstooltip-textright'>"+boolToString(h.members)+"</span><br/><span class='osrstooltip-textleft'>Quest Item : </span><span class='osrstooltip-textright'>"+boolToString(h.quest_item)+"</span><br/><span class='osrstooltip-textleft'>Stackable : </span><span class='osrstooltip-textright'>"+boolToString(h.stackable)+"</span><br/><span class='osrstooltip-textleft'>Equipable : </span><span class='osrstooltip-textright'>"+boolToString(h.equipable)+"</span><br/><span class='osrstooltip-textleft'>Tradeable : </span><span class='osrstooltip-textright'>"+boolToString(h.tradeable)+"</span><br/><span class='osrstooltip-textleft'>High Alchemy : </span><span class='osrstooltip-textright'>"+h.highalch+"</span><br/><span class='osrstooltip-textleft'>Low Alchemy : </span><span class='osrstooltip-textright'>"+h.lowalch+"</span><br/>";if(h.equipable==false){p="<div>"+i+j+l+j+"</div>";$("#"+h.id).osrstooltip("option","content",p);return}var g="<span class='textleft'>Stab : </span><span class='textright'>"+h.bonuses["attack_stab"]+"</span><br/><span class='textleft'>Slash : </span><span class='textright'>"+h.bonuses["attack_slash"]+"</span><br/><span class='textleft'>Crush : </span><span class='textright'>"+h.bonuses["attack_crush"]+"</span><br/><span class='textleft'>Magic : </span><span class='textright'>"+h.bonuses["attack_magic"]+"</span><br/><span class='textleft'>Ranged : </span><span class='textright'>"+h.bonuses["attack_ranged"]+"</span><br/>";var k="<table class='osrstooltip-table'><tr><th colspan='5'>Attack Bonus</th></tr><tr><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/stab.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/slash.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/crush.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/magic.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/ranged.png' alt=''></td></tr><tr><td>"+h.bonuses["attack_stab"]+"</td><td>"+h.bonuses["attack_slash"]+"</td><td>"+h.bonuses["attack_crush"]+"</td><td>"+h.bonuses["attack_magic"]+"</td><td>"+h.bonuses["attack_ranged"]+"</td></tr>";var c="<tr><th colspan='5'>Defence Bonus</th></tr><tr><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/stab.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/slash.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/crush.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/magic.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/ranged.png' alt=''></td></tr><tr><td>"+h.bonuses["defence_stab"]+"</td><td>"+h.bonuses["defence_slash"]+"</td><td>"+h.bonuses["defence_crush"]+"</td><td>"+h.bonuses["defence_magic"]+"</td><td>"+h.bonuses["defence_ranged"]+"</td></tr>";var q="<tr><th colspan='4'>Other Bonuses</th></tr><tr><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/melee_strength.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/ranged_strength.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/magic_damage.png' alt=''></td><td><img src='https://www.osrsbox.com/osrsbox-tooltips/images/prayer.png' alt=''></td></tr><tr><td>"+h.bonuses["melee_strength"]+"</td><td>"+h.bonuses["ranged_strength"]+"</td><td>"+h.bonuses["magic_damage"]+"</td><td>"+h.bonuses["prayer"]+"</td></tr></table>";p="<div>"+i+j+l+j+k+c+q+"</div>";$("#"+h.id).osrstooltip("option","content",p)}function errorFunction(a){$("#"+a.id).osrstooltip("option","content","Error getting content.")}function boolToString(a){if(a==true){return"True"}else{return"False"}};
