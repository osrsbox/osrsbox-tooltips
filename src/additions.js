$(document).ready(function(){
    ...
    $( ".tooltip span" ).tooltip({
        ...
        open: function( event, ui ) {
              ...
              var base_url = "https://osrsbox.github.io/osrsbox-db/items-json/"
...
function successFunction(data) {
    ...
    var img_url = "https://osrsbox.github.io/osrsbox-db/items-icons/" + category + "/" + data["id"] + ".png";
    var name = data['name'];
    ...
    var attack_table = "<table class='osrs-tooltip-table'><tr><th colspan='5'>Attack Bonus</th></tr><tr><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/stab.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/slash.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/crush.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/magic.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/ranged.png' alt=''></td></tr><tr><td>" + data['attack_stab'] + "</td>" + "<td>" + data['attack_slash'] + "</td>" + "<td>" + data['attack_crush'] + "</td>" + "<td>" + data['attack_magic'] + "</td>" + "<td>" + data['attack_ranged'] + "</td>" + "</tr>";

    var defence_table = "<tr><th colspan='5'>Defence Bonus</th></tr><tr><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/stab.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/slash.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/crush.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/magic.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/ranged.png' alt=''></td></tr><tr><td>" + data['defence_stab'] + "</td>" + "<td>" + data['defence_slash'] + "</td>" + "<td>" + data['defence_crush'] + "</td>" + "<td>" + data['defence_magic'] + "</td>" + "<td>" + data['defence_ranged'] + "</td>" + "</tr>";

    var other_bonuses_table = "<tr><th colspan='4'>Other Bonuses</th></tr><tr><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/stab.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/ranged_strength.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/magic_damage.png' alt=''></td><td><img src='https://osrsbox.github.io/osrsbox-tooltips/images/prayer.png' alt=''></td></tr><tr><td>" + data['melee_strength'] + "</td>" + "<td>" + data['ranged_strength'] + "</td>" + "<td>" + data['magic_damage'] + "</td>" + "<td>" + data['prayer'] + "</td>" + "</tr></table>";  
