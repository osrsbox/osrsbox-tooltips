...
function successFunction(data) {
    ...
    var other_bonuses_table = "<tr><th colspan='4'>Other Bonuses</th></tr><tr><td><img src='http://osrsbox.com/osrsbox-tooltips/images/melee_strength.png.png' alt=''></td><td><img src='http://osrsbox.com/osrsbox-tooltips/images/ranged_strength.png' alt=''></td><td><img src='http://osrsbox.com/osrsbox-tooltips/images/magic_damage.png' alt=''></td><td><img src='http://osrsbox.com/osrsbox-tooltips/images/prayer.png' alt=''></td></tr><tr><td>" + data['melee_strength'] + "</td>" + "<td>" + data['ranged_strength'] + "</td>" + "<td>" + data['magic_damage'] + "</td>" + "<td>" + data['prayer'] + "</td>" + "</tr></table>";  
